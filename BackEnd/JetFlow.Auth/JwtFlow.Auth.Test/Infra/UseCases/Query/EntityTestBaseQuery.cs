...
using JetFlow.Infra.UseCases.User.Query;
using JwtFlow.Auth.Test.Mock;
using Microsoft.Extensions.Caching.Memory;
using Microsoft.Extensions.Configuration;

namespace JwtFlow.Auth.Test.Infra.UseCases.Query;

public class EntityTestBaseQuery
{
    
    protected readonly HandlerQuery HandlerCommand;
    
    private readonly FakeUnitOfWork _fakeUnitOfWork = new FakeUnitOfWork();
    private readonly IConfiguration _mockConfiguration; 
    private readonly IMemoryCache _mockCache; 

    protected EntityTestBaseQuery()
    {
        ...
        HandlerCommand = new HandlerQuery(_fakeUnitOfWork, serviceToken);
    }
}